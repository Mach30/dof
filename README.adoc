...
What has changed is our approach to addressing OSHW project hosting.  This time we are starting with the development of a tool independent methodology for developing and sharing OSHW, the Distributed OSHW Framework (DOF).  What do we mean by methodology?  DOF will be a systematic approach identifying what needs to be shared, how it should be shared, and the relationships between the various kinds of shared content. 
